...
<div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-md-12">
<div class="card mb-4">
                    <h5 class="card-header">Manage Fees</h5>
                    <!-- Account -->
                    <hr class="my-0" />
                    <div class="card-body">
              ...
              <div class="card-body">
              @include('admin.service_provider.service_model')
                <div> 
                <input type="hidden" id="s_provider_id" value="{{$data['provider_id']}}">                 
                    ...
                    <tbody class="table-border-bottom-0">
                      @foreach($data['services'] as $service)
                        <tr>
                          ...
                          <td><strong>{{$service['service_name']}}</strong></td>
                          @if($service['service_type'] == 'aO2ki1')
                          ...
                          @endif 
                          <td><a href="{{ url('/admin')}}{{'/'.$data['provider_id'].'/service/'.$service['service_id']}}" class="menu-link">Edit</td>
                        </tr>
                      @endforeach                   
                    </tbody>
                  </table>
